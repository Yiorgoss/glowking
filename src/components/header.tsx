    ...
    return (
        <div>
            <div className=' grid h-[100px] w-full grid-flow-row-dense grid-cols-2 uppercase text-primary md:grid-cols-5'>
                ...
                <div
                    className={`flex-reverse my-auto mr-10 ml-auto flex h-full items-center justify-center gap-8 text-center text-sm md:hidden ${
                ...
                <div
                    className={`mx-auto my-auto text-sm font-medium ${
                        isHomePage ? 'text-primary' : 'text-secondary'
                    } md:col-span-3 md:pb-0 md:pt-4 md:text-base md:font-semibold ${
                        isOpen
