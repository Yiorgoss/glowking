...
export default function Footer({
    ...
    const contactDetails = [
        ...
        t({
            id: 'Footer.contact',
            message: 'We come to where you are with one click!'
        })
    ];
    ...
    return (
        <div className='top-0 z-10 mt-10 bg-slate-800 pb-10 md:py-10'>
            <div className='container mx-auto grid grid-cols-2 gap-10 text-white'>
                ...
                <div className='grid-col-1 col-span-full my-auto mr-auto grid gap-4 divide-y pl-8 md:col-span-1 md:mx-auto md:grid-cols-3 md:divide-none'>
                    <div className=''>
